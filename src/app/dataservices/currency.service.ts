...
export class CurrencyService {
 ...
 countries=[
  ...
  getbyId(id): Observable<Currency> {
    return this.http.get<Currency>(`${environment.apiUrl}/currency/${id}/`)
  }
  Add(currency:Currency): Observable<Currency> {
    console.log(currency);
    return this.http.post<Currency>(`${environment.apiUrl}/currency/`,currency)
    
  }
  update(currency:Currency): Observable<Currency> {
    return this.http.put<Currency>(`${environment.apiUrl}/currency/${currency.id}/`,currency)
    
  }
  delete(id): Observable<Currency> {
    return this.http.delete<Currency>(`${environment.apiUrl}/currency/${id}/`);
